                            ...
                            <div className="product-sidebar">
                                ...
                                <div className="product-sidebar-widget">
                                    ...
                                    <div className="custom-control custom-checkbox">
                                        ...
                                        <label className="custom-control-label" for="size-4">Extra Large</label>
                                    </div>
                                </div>
                                <div className="product-sidebar-widget">
                                    ...
                                    <div className="custom-control custom-checkbox">
                                        ...
                                        <label className="custom-control-label" for="brand-4">Brand Name #4</label>
                                    </div>
                                </div>
                                <div className="product-sidebar-widget">
                                    ...
                                    <div className="custom-control custom-radio custom-color-black ">
                                        ...
                                        <label className="custom-control-label" for="color-4">Black</label>
                                    </div>
                                </div>
                                <div className="product-sidebar-widget">
